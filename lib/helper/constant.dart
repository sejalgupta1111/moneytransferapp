...
class AppColor {
  static  Color primaryColor = const Color(0xFFD3D3D3);
  static  Color secondaryColor = const Color(0xFF0047CB);
  ...
  //static  Color textfeildclr = const Color(0xFFfef6f6);
...
class SessionHelper {
  ...
  static const String ALL_DATA = "ALL_DATA";
